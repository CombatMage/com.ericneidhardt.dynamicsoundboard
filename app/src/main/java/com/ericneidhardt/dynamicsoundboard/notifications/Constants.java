...
{
	public static final int NOTIFICATION_ID_PLAYLIST = "com.ericneidhardt.dynamicsoundboard.notifications.NOTIFICATION_ID_PLAYLIST".hashCode(); // must be a random, unique id
