...
public abstract class BaseFragment extends Fragment
{
	...
	public SoundLayoutsManagerFragment getSoundLayoutsManagerFragment()
	{
		return (SoundLayoutsManagerFragment)this.getFragmentManager().findFragmentByTag(SoundLayoutsManagerFragment.TAG);
	}
