	...
	fun AppCompatActivity.requestPermissionsReadPhoneStateIfRequired()
	{
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED)
		{
			if (!ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_PHONE_STATE))
				ExplainPermissionDialog(this.supportFragmentManager, R.string.request_permission_read_phone_state_message,
	...
	fun AppCompatActivity.requestPermissionsReadStorageIfRequired(): Boolean
	{
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
		{
			if (!ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE))
				ExplainPermissionDialog(this.supportFragmentManager, R.string.request_permission_read_storage_message,
	...
	fun AppCompatActivity.requestPermissionsWriteStorageIfRequired()
	{
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
		{
			if (!ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE))
				ExplainPermissionDialog(this.supportFragmentManager, R.string.request_permission_write_storage_message,
